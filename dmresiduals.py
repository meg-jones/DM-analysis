...
coeffs, matcov = curve_fit(func, x, y, p0,maxfev=2000)
...
plt.tick_params(axis='y', pad=10)
#plt.set_xticklabels([])
fig.text(0.17, 0.84, 'J1747$-$4036',fontsize=20, fontproperties=prop)
    
plt.subplot(212)
#plt.title('DM Residuals', fontsize=14,fontproperties=prop)
